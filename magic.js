...
async function drawImage(canvas, density, method, width, height, scaling, timeperstep, maxValue, maxLineLength) {
...
async function drawLine(ctx, startX, startY, endX, endY, delay) {
    ctx.beginPath()
